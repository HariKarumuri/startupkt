...
const About3 = () => {
  return (
    <>
      <div className="container About3 mt-0 pt-0">
        <div className="row my-5 text-center">
          <div className="col-lg-6 col-12   d-flex justify-content-center align-items-center ">
            <div className="RoundBG">
              <h4>
                The best results come from following the best process, which is
                what we do.
              </h4>
            </div>
          </div>
          <div className="col-lg-6 col-12 d-flex justify-content-center align-items-center">
            <img
              src={vect4}
              className="img-fluid About3-images"
              alt="startup-image "
            ...
            <div className="card Alt">
              <div className="card-body">
                ...
                <p className="card-text">
                  Lets have a detailed discussion about your requirement. It
                  helps us to bring your idea to a Product.
                </p>
                <p className="card-text">
          ...
          <div className="col-12 col-lg-3 col-md-6">
            <div className="card Alt">
              <div className="card-body">
                ...
                <p className="card-text">
                  You get what you imagined and approved.
                </p>
              </div>
          ...
          <div className="col-12 col-lg-3 col-md-6">
            <div className="card">
              <div className="card-body">
                ...
                <p className="card-text">
                  We are highly efficient in coding a zero bug projects. We
                  ensure your application passes through multiple testing
                  process before we deliver.
                </p>
                <p className="card-text">
          ...
          <div className="col-12 col-lg-3 col-md-6 ">
            <div className="card">
              <div className="card-body">
                ...
                <p className="card-text">
                  Internet is the new market place. We make you highlighted in
                  all the platforms and take your business to the next level.
                </p>
                <p className="card-text">
          ...
          <div className="col-12 col-lg-3 col-md-6">
            <div className="card Alt">
              <div className="card-body">
                ...
                <p className="card-text">
                  We can do everything by ourselves. But a right expert will
                  guide you to do right things at right time.
                </p>
                <p className="card-text">
                  We will connect you with the right mentor for your personal
                  and business growth.
                </p>
              </div>
          ...
          <div className="col-12 col-lg-3 col-md-6">
            <div className="card">
              <div className="card-body">
                ...
                <p className="card-text">
                  Get networking with 300+ startup co-founders and business
                  owners across country wide in multiple segments.
                </p>
              </div>
